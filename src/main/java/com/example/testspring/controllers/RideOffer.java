...
public  class RideOffer implements Subject {
    ...
    private double haveDiscount(User user, Driver aThis , String des, DataSystem database){
        ...
        {
            if(user.getEmail().equals(database.rides.get(i).getUser().getEmail()) && aThis.getEmail().equals(database.rides.get(i).getDriver().getEmail()))
            {
        ...
        if(user.getBirthday().getDayOfMonth()==d.getDayOfMonth() && user.getBirthday().getMonthValue()==d.getMonthValue())
        {
            discount+=10;
    ...
    public void notifyUser(User user,DataSystem dataSystem){
        ...
        {
            if((user.getEmail().equals(dataSystem.users.get(i).getEmail())) &&(user.getMobilNumber().equals(dataSystem.users.get(i).getMobilNumber()))){
